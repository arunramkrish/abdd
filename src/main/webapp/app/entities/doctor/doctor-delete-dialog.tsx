...
export const DoctorDeleteDialog = (props: IDoctorDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="abddApp.doctor.delete.question">
        <Translate contentKey="abddApp.doctor.delete.question" interpolate={{ id: doctorEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-doctor" color="danger" onClick={confirmDelete}>
